...
// SETTINGS
// ============================================================
function SettingsView({ profile, setProfile, trades, confluences, onReset, showToast }) {
      ...
      {phase === 'app' && profile && (
        <div className="tlp-app">
          ...
          <main className="tlp-main">
            ...
            {view === 'trades' && (
              <TradesView trades={trades} onOpenTrade={setDetail} onLog={() => setTradeFormOpen(true)} />
            )}
            {view === 'settings' && (
              <>
                ...
                {settingsSubView === 'main' ? (
                  <SettingsView profile={profile} setProfile={setProfile} trades={trades} confluences={confluences} onReset={resetAll} showToast={setToast} />
                ) : (
